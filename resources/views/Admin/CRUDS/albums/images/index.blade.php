        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header d-flex align-items-center">
                    <h5 class="card-title mb-0 flex-grow-1"> صور الالبوم {{$album ->title}}</h5>

                        <div>
                            <button id="addImage" class="btn btn-primary">اضافة صورة للابوم</button>
                        </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg mw-650px">
            ...
            <div class="modal-content" id="modalContent">
                ...
                <div class="modal-header">
                    <!--begin::Modal title-->
                    <h2><span id="operationType"></span> صورة </h2>
                    <!--end::Modal title-->
                    <!--begin::Close-->
